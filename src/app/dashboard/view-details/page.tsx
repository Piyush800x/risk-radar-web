...
export default function ViewDetails() {
  ...
  return (
    <>
      ...
      <div className="bg-[#FFBDBD] dark:bg-[#FF6565]/20 p-4 rounded-md flex flex-col justify-between">
        ...
        <div className="flex w-full justify-end mt-8">
          <Button className="bg-[#fafafa] text-[#000000] hover:bg-[#fafafa]/90">Learn more</Button>
        </div>
      </div>
    </>
  );
